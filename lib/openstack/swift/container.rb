...
module Swift
  class Container
    ...
    def set_metadata(metadatahash)
      ...
      begin
        response = @swift.connection.req("POST", CGI.escape("/#{@name.to_s}"), {:headers=>headers} )
        true
    ...
    def objects(params = {})
      ...
      response = @swift.connection.req("GET", CGI.escape(path))
    ...
    def object_exists?(objectname)
      ...
      begin
        response = @swift.connection.req("HEAD", CGI.escape(path))
        true
    ...
    def delete_object(objectname)
      path = "/#{@name.to_s}/#{objectname}"
      begin
        response = @swift.connection.req("DELETE", CGI.escape(path))
        true
      rescue OpenStack::Exception::ItemNotFound => not_found
