...
module Compute
  class Server
    ...
    def reboot(type="SOFT")
      ...
      response = @compute.connection.csreq("POST",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}/action",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'},data)
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
      true
    end
    ...
    def update(options)
      ...
      response = @compute.connection.csreq("PUT",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'},data)
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
    ...
    #   => true
    def delete!
      response = @compute.connection.csreq("DELETE",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}",@svrmgmtport,@svrmgmtscheme)
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
      true
    end
    ...
    #   => array
    def interface_list
      response = @compute.connection.csreq("GET",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}/os-interface",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'})
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
    ...
    def interface_details(id)
      response = @compute.connection.csreq("GET",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}/os-interface/#{id}",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'})
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
    ...
    def interface_create(options)
      ...
      response = @compute.connection.csreq("POST",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}/os-interface",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'},data)
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
      JSON::parse(response.body)["interfaceAttachment"]
    end
    ...
    def interface_delete(id)
      response = @compute.connection.csreq("DELETE",@svrmgmthost,"#{@svrmgmtpath}/servers/#{CGI.escape(self.id.to_s)}/os-interface/#{id}",@svrmgmtport,@svrmgmtscheme,{'content-type' => 'application/json'})
      OpenStack::Exception.raise_exception(response) unless response.code.match(/^20.$/)
      true
    end
